...
Corresponding functions in the [gprofiler2](https://cran.r-project.org/web/packages/gprofiler2/index.html) R package are:
...
```{r eval = F}
download.file(url = "http://software.broadinstitute.org/gsea/resources/msigdb/7.0/c2.cp.biocarta.v7.0.symbols.gmt", destfile = "data/biocarta.gmt")
```

```{r eval = F}
upload_GMT_file(gmtfile = "../data/biocarta.gmt")
```
